...
function Sidebar() {
    ...
    return (
        <div className="sticky top-14 z-10 h-[92vh] bottom-0">
            ...
            <div className={`w-64 z-40 absolute bg-gray-800 shadow md:h-full flex-col justify-between sm:hidden  transition duration-150 ease-in-out ${mobile_nav}`} id="mobile-nav">
